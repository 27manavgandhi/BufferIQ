...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_users_buffer_org_id"), "users", ["buffer_org_id"], unique=True
    )
    ...
    op.create_index(
        op.f("ix_organizations_buffer_org_id"),
        "organizations",
        ["buffer_org_id"],
        unique=True,
    )
    op.create_index(
        op.f("ix_organizations_user_id"), "organizations", ["user_id"], unique=False
    )
    op.create_index(
        "idx_org_user_buffer",
        "organizations",
        ["user_id", "buffer_org_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_channels_buffer_channel_id"),
        "channels",
        ["buffer_channel_id"],
        unique=True,
    )
    op.create_index(
        op.f("ix_channels_organization_id"),
        "channels",
        ["organization_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_channels_platform"), "channels", ["platform"], unique=False
    )
    op.create_index(
        "idx_channel_platform_active",
        "channels",
        ["platform", "is_active"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_posts_buffer_post_id"), "posts", ["buffer_post_id"], unique=True
    )
    op.create_index(op.f("ix_posts_channel_id"), "posts", ["channel_id"], unique=False)
    op.create_index(
        op.f("ix_posts_content_hash"), "posts", ["content_hash"], unique=False
    )
    op.create_index(
        op.f("ix_posts_published_at"), "posts", ["published_at"], unique=False
    )
    op.create_index(
        op.f("ix_posts_scheduled_at"), "posts", ["scheduled_at"], unique=False
    )
    op.create_index(op.f("ix_posts_status"), "posts", ["status"], unique=False)
    op.create_index(
        "idx_post_channel_status", "posts", ["channel_id", "status"], unique=False
    )
    op.create_index(
        "idx_post_channel_published",
        "posts",
        ["channel_id", "published_at"],
        unique=False,
    )
    op.create_index(
        "idx_post_scheduled", "posts", ["scheduled_at", "status"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            "training_data_size > 0", name="check_training_size_positive"
        ),
        sa.ForeignKeyConstraint(["user_id"], ["users.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        op.f("ix_model_versions_user_id"), "model_versions", ["user_id"], unique=False
    )
    op.create_index(
        op.f("ix_model_versions_version"), "model_versions", ["version"], unique=False
    )
    op.create_index(
        "idx_model_user_version", "model_versions", ["user_id", "version"], unique=False
    )
    op.create_index(
        "idx_model_active", "model_versions", ["is_active", "user_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            "predicted_likes >= 0", name="check_predicted_likes_positive"
        ),
        sa.CheckConstraint(
    ...
    op.create_index(
        op.f("ix_predictions_model_version_id"),
        "predictions",
        ["model_version_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_predictions_post_id"), "predictions", ["post_id"], unique=False
    )
    op.create_index(
        op.f("ix_predictions_prediction_made_at"),
        "predictions",
        ["prediction_made_at"],
        unique=False,
    )
    op.create_index(
        "idx_prediction_post_model",
        "predictions",
        ["post_id", "model_version_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_voice_profiles_user_id"), "voice_profiles", ["user_id"], unique=True
    )
    ...
    op.create_index(
        op.f("ix_content_gaps_topic"), "content_gaps", ["topic"], unique=False
    )
    op.create_index(
        op.f("ix_content_gaps_user_id"), "content_gaps", ["user_id"], unique=False
    )
    op.create_index(
        "idx_gap_user_score",
        "content_gaps",
        ["user_id", "opportunity_score"],
        unique=False,
    )
    ...
    op.create_index(
        "idx_sync_user_status", "sync_jobs", ["user_id", "status"], unique=False
    )
