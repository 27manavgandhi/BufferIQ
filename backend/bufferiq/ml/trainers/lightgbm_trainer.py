...
class LightGBMTrainer(BaseTrainer):
    ...
    def __init__(
        self, model_name: str = "lightgbm", random_state: int = 42, verbose: bool = True
    ) -> None:
        """
        ...
        Example:
            ...
            >>> hyperparams = {"n_estimators": 150, "max_depth": 7}
    ...
    def build_model(self, hyperparameters: Dict[str, Any]) -> lgb.LGBMRegressor:
        """
        Build LightGBM model with hyperparameters.
        ...
        if self.verbose:
            logger.info(f"Built LightGBM model with params: {params}")
    ...
    def train(
        ...
        Example:
            >>> trainer = LightGBMTrainer()
            >>> trainer.build_model({"n_estimators": 150})
